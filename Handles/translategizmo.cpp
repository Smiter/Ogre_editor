#include "Handles/translategizmo.h"
...
TranslateGizmo::TranslateGizmo()
{
    ...
    MainAxisNode = scnMgr->getRootSceneNode()->createChildSceneNode("MainAxisNode");
    lineX =  scnMgr->createManualObject("lineX");
    NodelineX = MainAxisNode->createChildSceneNode("NodelineX");
    lineY =  scnMgr->createManualObject("lineY");
    NodelineY = MainAxisNode->createChildSceneNode("NodelineY");
    lineZ =  scnMgr->createManualObject("lineZ");
    NodelineZ = MainAxisNode->createChildSceneNode("NodelineZ");
    lineXCone=  scnMgr->createManualObject("lineXCone");
    NodelineXCone = MainAxisNode->createChildSceneNode("NodelineXCone");
    lineYCone=  scnMgr->createManualObject("lineYCone");
    NodelineYCone = MainAxisNode->createChildSceneNode("NodelineYCone");
    lineZCone=  scnMgr->createManualObject("lineZCone");
    NodelineZCone = MainAxisNode->createChildSceneNode("NodelineZCone");
    Quadr=  scnMgr->createManualObject("Quadr");
