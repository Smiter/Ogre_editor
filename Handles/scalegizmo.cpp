#include "Handles/scalegizmo.h"
#include "mainwindow.h"

ScaleGizmo::ScaleGizmo()
{
    Ogre::SceneManager *scnMgr = MainWindow::getInstance()->ogreWindow->getSceneManager();

    MainScaleNode = scnMgr->getRootSceneNode()->createChildSceneNode("MainScaleNode");
    lineXScale =  scnMgr->createManualObject("lineXscale");
    NodelineXScale = MainScaleNode->createChildSceneNode("NodelineXscale");
    lineYScale =  scnMgr->createManualObject("lineYscale");
    NodelineYScale = MainScaleNode->createChildSceneNode("NodelineYscale");
    lineZScale =  scnMgr->createManualObject("lineZscale");
    ...
    ScaleXent = scnMgr->createEntity("cubX",Ogre::SceneManager::PT_CUBE);
    NodescaleXQuadr->attachObject( ScaleXent );
    ScaleXent->setCastShadows(false);
    ScaleYent = scnMgr->createEntity("cubY",Ogre::SceneManager::PT_CUBE);
    NodescaleYQuadr->attachObject( ScaleYent );
    ScaleYent->setCastShadows(false);
    ScaleZent = scnMgr->createEntity("cubZ",Ogre::SceneManager::PT_CUBE);
