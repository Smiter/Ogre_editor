...
RotateGizmo::RotateGizmo()
{
    ...
    MainRotateNode = scnMgr->getRootSceneNode()->createChildSceneNode("MainRotateNode");
    CircleY=  scnMgr->createManualObject("CircleY");
    NodeCircleY = MainRotateNode->createChildSceneNode("NodeCircleY");
    CircleX=  scnMgr->createManualObject("CircleX");
    NodeCircleX = MainRotateNode->createChildSceneNode("NodeCircleX");
    CircleZ=  scnMgr->createManualObject("CircleZ");
